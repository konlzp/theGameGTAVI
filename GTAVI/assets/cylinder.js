...
function Cylinder (resolution, upperRadius, lowerRadius) {
	...
	for (var i = 0; i < resolution; i++) {
		...
		this.vertices[vertexoffset] = lowerRadius * Math.cos(angle);
		this.vertices[vertexoffset+1] = 0.0;
		this.vertices[vertexoffset+2] = lowerRadius * Math.sin(angle);
		vertexoffset += 3;
	}
	...
	for (var i = 0; i < resolution; i++) {
		...
		this.vertices[vertexoffset] = upperRadius * Math.cos(angle);
		this.vertices[vertexoffset+1] = 2.0;
		this.vertices[vertexoffset+2] = upperRadius * Math.sin(angle);
		vertexoffset += 3;
	}
